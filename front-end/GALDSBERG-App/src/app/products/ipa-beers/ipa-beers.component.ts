...
@Component({
  selector: 'app-ipa-beers',
  templateUrl: './ipa-beers.component.html',
  styleUrls: ['./ipa-beers.component.css']
})
export class IpaBeersComponent implements OnInit {
  ...
  private getBeers(){
    this.beerService.getIpaBeersList().subscribe(data=>{
      this.beers=data;
    });
  }
